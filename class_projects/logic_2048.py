...
def add_new_2 (mat):
    ...
    # ransom cell chosen will be empty
    # ( or contain zero)
    while(mat [r] != 0):
        r = random.randint (0,3)
        c = random.randint (0,3)
...
def move_down(grid):
    ...
    # to move down we take the transpose
    new_grid = transpose(grid)

    # to move right and then again
...
# this fill only contains all the logic
