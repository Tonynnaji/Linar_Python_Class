...
pygame.display.set_caption("Welcome to the Solar System Visualizer_Final_Project")
...
while running:
    ...
    for planet in planets [1:]:
        ...
        for i in range(1, len(planet["past _positions"])):
            pygame.draw.line(screen, (153,153,0), planet["past _positions"][i - 1], planet["past _positions"][i], 1)
